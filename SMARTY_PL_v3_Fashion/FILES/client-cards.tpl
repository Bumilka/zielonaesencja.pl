						...
						{{if  $xml->getItem("/shop/page/cards/item")}}
							<div id="client_cards">
								...
								<table>
									...
									{{foreach from=$xml->getList("/shop/page/cards/item") item=loop299}}
										<tr>
											<td class="client_cards_expires">{{$loop299->getItemEscape("@expires")}}
											</td>
											<td class="client_cards_name">{{$loop299->getItemEscape("@name")}}
											</td>
											<td class="client_cards_number">{{$loop299->getItemEscape("@number")}}
											</td>
											<td class="client_cards_active">
												{{if  $loop299->getItem("@active")  == (string) 'y'}}
													{{$txt['107771::61881_6']}}
												{{elseif  $loop299->getItem("@active")  == (string) 'n'}}
													{{$txt['107771::61881_7']}}
												{{else}}
													{{$txt['107771::61881_8']}}
												{{/if}}
