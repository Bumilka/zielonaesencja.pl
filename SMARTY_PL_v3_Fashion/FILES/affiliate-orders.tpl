								...
								<div class="affiliate_orders">
									<div class="affiliate_orders_sub">
										<table {{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}affiliate_orders{{/capture}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}ui-responsive table-stroke ui-table ui-table-reflow affiliate_orders{{/capture}}  class="{{$classAttributeTmp4}}">
											...
											<tbody>
												{{foreach from=$xml->getList("page/orders/client") item=loop307}}
													<tr {{assign "classAttributeTmp5" ""}}{{if $loop307@iteration % 2}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}affiliate_orders_row1{{/capture}}{{else}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}affiliate_orders_row2{{/capture}}{{/if}}  class="{{$classAttributeTmp5}}">
														...
														<td>{{$loop307->getItemEscape("@setDate")}}
														</td>
														<td>{{$loop307->getItemEscape("@totalCount")}}
														</td>
														<td>
															<span class="affiliate_orders_price">{{$loop307->getItemEscape("@totalSum_formatted")}}</span>
														</td>
														<td>{{$loop307->getItemEscape("@sentCount")}}
														</td>
														<td>
															<span class="affiliate_orders_price">{{$loop307->getItemEscape("@sentSum_formatted")}}</span>
														</td>
													</tr>
												{{/foreach}}
						...
						{{if count( $xml->getList("page/orders/navigation/item"))}}
							<ul class="pagination pull-right">
								{{if count( $xml->getList("page/orders/navigation/item"))  gt (string) 1}}
									...
									{{/if}}
									{{foreach from=$xml->getList("page/orders/navigation/item") item=loop383}}
