						...
						<div id="client-files" class="n68137">
							{{if  $xml->getItem("page/client_files/@mode")  == (string) 'to_download'}}
								<div class="n68137_downloadable">
									...
									<div class="n68137_files">
										{{foreach from=$xml->getList("/shop/page/client_files/product_data") item=loop276}}
											<div class="n68137_file">
												<div class="n68137_files_image">
													<img class="n68137_img" src="{{$loop276->getItemEscape("@icon")}}" alt="{{$loop276->getItemEscape("product_attachments/attachment/@file_name")}}"></img>
												</div>
												<div class="n68137_files_description">
													<a class="n68137_desc_name" href="{{$loop276->getItemEscape("@link")}}">{{$loop276->getItemEscape("@name")}}</a>
													<div class="n68137_files_description_order">
														...
														<span class="n68137_desc_value">
															<a class="n68137_desc_value" href="{{$loop276->getItemEscape("@order_link")}}">{{$loop276->getItemEscape("@order_sn")}}</a></span>
													</div>
													<div class="n68137_files_description_availability">
														<span class="n68137_desc_label">{{$txt['107772::68137_availability']}}</span>
														<span class="n68137_desc_value">
															{{if  $loop276->getItem("@available")  == (string) 'y'}}
												...
												{{else}}
													<a class="n68137_files_pay btn-small" href="{{$loop276->getItemEscape("@order_link")}}">{{$txt['107772::68137_pay']}}</a>
												{{/if}}
												<div class="clearDiv">
												</div>
												<div class="n68137_popup">
													...
													<div class="n68137_description_popup">{{$txt['107772::68137_cms_popup']}}
														<div class="n68137_description_cms_popup">{{$loop276->getItemEscape("/shop/page/cms_txt/cms[@type='toplayer']")}}
														</div>
													</div>
													{{foreach from=$loop276->getList("product_attachments/attachment") item=loop328}}
														<div class="n68137_files_description_popup">
															<div class="n68137_desc_popup">
																<div class="n68137_desc_name_popup">
																	{{if  $loop328->getItem("@name") and  $loop328->getItem("@name")  neq (string) ''}}
																		<span class="n68137_desc_name_popup">{{$loop328->getItemEscape("@name")}}</span>
																	{{/if}}
																	{{if  $loop328->getItem("@size_mb") and  $loop328->getItem("@size_mb")  neq (string) '' and  $loop328->getItem("@size_mb")  gt (string) 0}}
																		<span class="n68137_desc_size_popup">{{$txt['107772::68137_desc_size_popup_bracket_open']}}{{$loop328->getItemEscape("@size_mb")}}{{$txt['107772::68137_desc_size_popup_bracket_close']}}</span>
																	{{/if}}
																</div>
																<div class="n68137_desc_availability_popup">{{$txt['107772::68137_available']}}
																	{{if  $loop328->getItem("@unlimited") == (string)'true'}}
																		{{$txt['107772::68137_unlimited']}}
																		{{if  $loop328->getItem("@expiration_date")}}
																			{{$txt['107772::68137_until']}}{{$loop328->getItemEscape("@expiration_date")}}
																		{{/if}}
																	{{elseif ( $loop328->getItem("@unlimited") == (string)'false') and !( $loop328->getItem("@downloads_limit"))}}
																		{{$txt['107772::68137_unlimited']}}
																		{{if  $loop328->getItem("@expiration_date")}}
																			{{$txt['107772::68137_until']}}{{$loop328->getItemEscape("@expiration_date")}}
																		{{/if}}
																	{{else}}
																		{{$loop328->getItemEscape("@downloads_left")}}
																		{{if  $loop328->getItem("@downloads_left")  == (string) 1}}
															...
															<a class="btn-small n68137_files_download_popup" href="{{$loop328->getItemEscape("@download_link")}}">
																<span class="n68137_button_label_popup">{{$txt['107772::68137_button_label_popup']}}
																	<span class="n68137_button_value_popup">{{$loop328->getItemEscape("@file_extension")}}</span></span></a>
															<div class="clearDiv">
															</div>
														</div>
													{{/foreach}}
							...
							{{elseif  $xml->getItem("page/client_files/@mode")  == (string) 'not_available'}}
								<div class="n68137_notdownloadable">
									...
									<div class="n68137_files">
										{{foreach from=$xml->getList("/shop/page/client_files/product_data") item=loop398}}
											<div class="n68137_file">
												<div class="n68137_files_image">
													<img class="n68137_img" src="{{$loop398->getItemEscape("@icon")}}" alt="{{$loop398->getItemEscape("product_attachments/attachment/@file_name")}}"></img>
												</div>
												<div class="n68137_files_description">
													<a class="n68137_desc_name" href="{{$loop398->getItemEscape("@link")}}">{{$loop398->getItemEscape("@name")}}</a>
													<div class="n68137_files_description_order">
														<span class="n68137_desc_label">{{$txt['107772::68137_order']}}</span>
														<a class="n68137_desc_value" href="{{$loop398->getItemEscape("@order_link")}}">{{$loop398->getItemEscape("@order_sn")}}</a>
													</div>
													<div class="n68137_files_description_availability">
														<span class="n68137_desc_label">{{$txt['107772::68137_availability']}}</span>
														<span class="n68137_desc_value">
															{{if  $loop398->getItem("product_attachments/@downloads_left")  == (string) '0'}}
												...
												{{if  $loop398->getItem("@available") == (string)'y'}}
													<a class="btn-small n68137_files_buy" href="{{$loop398->getItemEscape("@link")}}">{{$txt['107772::68137_buy']}}</a>
												{{/if}}
												<div class="clearDiv">
												</div>
											</div>
