								...
								{{if  $xml->getItem("/shop/page/additional/hotspot/products_zone1/product") or  $xml->getItem("/shop/page/additional/hotspot/products_zone1/opinion")}}
									...
									<div class="align_row main_hotspot_sub">
										<div class="products_wrapper row m-0">
											{{foreach from=$xml->getList("/shop/page/additional/hotspot/products_zone1/*") item=loop359}}
												{{capture name="var_name" assign="var_name"}}
													{{if  $loop359->getItem("product")}}
														{{$loop359->getItem("product/name/text()")}}
													{{else}}
														{{$loop359->getItem("name/text()")}}
													{{/if}}
												{{/capture}}
												{{capture name="var_icon" assign="var_icon"}}
													{{if  $loop359->getItem("product")}}
														{{$loop359->getItemEscape("product/icon")}}
													{{else}}
														{{$loop359->getItemEscape("icon")}}
													{{/if}}
												{{/capture}}
												{{capture name="var_icon_small" assign="var_icon_small"}}
													{{if  $loop359->getItem("product")}}
														{{$loop359->getItemEscape("product/icon_small")}}
													{{else}}
														{{$loop359->getItemEscape("icon_small")}}
													{{/if}}
												{{/capture}}
												{{capture name="var_link" assign="var_link"}}
													{{if  $loop359->getItem("product")}}
														{{$loop359->getItemEscape("product/@link")}}
													{{else}}
														{{$loop359->getItemEscape("@link")}}
													{{/if}}
												{{/capture}}
												...
												<div class="product_wrapper col-6 col-sm-3">
													{{if $var_yousave and !($var_yousave  == (string) '') and  $loop359->getItem("price/@yousave_formatted")  neq (string) ''}}
														<div class="hotspot_yousave">
															<span class="yousave_label">{{$var_yousave}}</span>
															<span class="yousave_value">{{$loop359->getItemEscape("price/@yousave_formatted")}}</span>
														</div>
													{{/if}}
													<a class="product-icon d-flex justify-content-center align-items-center" data-product-id="{{$loop359->getItemEscape("@id")}}" href="{{$var_link}}" title="{{$var_name}}">
														<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/loader.gif?r=1570606968" class="b-lazy" data-src-small="{{$loop359->getItem("$var_icon_small")}}" data-src="{{$loop359->getItem("$var_icon")}}" alt="{{$loop359->getItem("$var_name")}}"></img></a>
													<h3>
													...
													{{if $var_net_prices  == (string) ''}}
														{{capture name="var_size_min_formatted" assign="var_size_min_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_max_formatted" assign="var_size_max_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_max_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_max_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_min_maxprice_formatted" assign="var_size_min_maxprice_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min_maxprice_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min_maxprice_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_max_maxprice_formatted" assign="var_size_max_maxprice_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_max_maxprice_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_max_maxprice_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_points" assign="var_points"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@points")}}
															{{else}}
																{{$loop359->getItemEscape("price/@points")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_value" assign="var_value"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_price_formatted" assign="var_price_formatted"}}
															{{if  $loop359->getItem("price/@price_unit_formatted") and  $loop359->getItem("sizes/@unit")}}
																{{$loop359->getItemEscape("price/@price_unit_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("sizes/@unit_sellby")}}{{literal}}{{/literal}}{{$loop359->getItemEscape("sizes/@unit")}}
															{{elseif  $loop359->getItem("product/price/@price_unit_formatted") and  $loop359->getItem("product/sizes/@unit")}}
																{{$loop359->getItemEscape("product/price/@price_unit_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("product/sizes/@unit_sellby")}}{{literal}}{{/literal}}{{$loop359->getItemEscape("product/sizes/@unit")}}
															{{else}}
																{{$var_size_min_formatted}}
															{{/if}}
														{{/capture}}
														{{capture name="var_maxprice_formatted" assign="var_maxprice_formatted"}}
															{{if  $loop359->getItem("price/@maxprice_unit_formatted")}}
																{{$loop359->getItemEscape("price/@maxprice_unit_formatted")}}
															{{elseif  $loop359->getItem("product/price/@maxprice_unit_formatted")}}
																{{$loop359->getItemEscape("product/price/@maxprice_unit_formatted")}}
															{{elseif  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@maxprice_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@maxprice_formatted")}}
															{{/if}}
														{{/capture}}
														<div class="product_prices">
															...
															{{else}}
																...
																{{/if}}
															{{/if}}
															{{if  $loop359->getItem("price/@unit_converted_price_formatted")}}
																<small class="s_unit_converted_price">{{$loop359->getItemEscape("price/@unit_converted_price_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("price/@unit_converted_format")}}</small>
															{{/if}}
														</div>
													{{else}}
														{{capture name="var_size_min_net_formatted" assign="var_size_min_net_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min_net_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min_net_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_max_net_formatted" assign="var_size_max_net_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_max_net_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_max_net_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_min_net_maxprice_formatted" assign="var_size_min_net_maxprice_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min_maxprice_net_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min_maxprice_net_formatted")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_size_max_maxprice_net_formatted" assign="var_size_max_maxprice_net_formatted"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_max_maxprice_net_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_max_maxprice_net_formatted")}}
															{{/if}}
														{{/capture}}
														...
														{{capture name="var_net_value" assign="var_net_value"}}
															{{if  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@size_min_net")}}
															{{else}}
																{{$loop359->getItemEscape("price/@size_min_net")}}
															{{/if}}
														{{/capture}}
														{{capture name="var_price_formatted" assign="var_price_formatted"}}
															{{if  $loop359->getItem("price/@price_unit_net_formatted") and  $loop359->getItem("sizes/@unit")}}
																{{$loop359->getItemEscape("price/@price_unit_net_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("sizes/@unit_sellby")}}{{literal}}{{/literal}}{{$loop359->getItemEscape("sizes/@unit")}}
															{{elseif  $loop359->getItem("product/price/@price_unit_net_formatted") and  $loop359->getItem("product/sizes/@unit")}}
																{{$loop359->getItemEscape("product/price/@price_unit_net_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("product/sizes/@unit_sellby")}}{{literal}}{{/literal}}{{$loop359->getItemEscape("product/sizes/@unit")}}
															{{else}}
																{{$var_size_min_net_formatted}}
															{{/if}}
														{{/capture}}
														{{capture name="var_maxprice_net_formatted" assign="var_maxprice_net_formatted"}}
															{{if  $loop359->getItem("price/@maxprice_unit_net_formatted")}}
																{{$loop359->getItemEscape("price/@maxprice_unit_net_formatted")}}
															{{elseif  $loop359->getItem("product/price/@maxprice_unit_net_formatted")}}
																{{$loop359->getItemEscape("product/price/@maxprice_unit_net_formatted")}}
															{{elseif  $loop359->getItem("product")}}
																{{$loop359->getItemEscape("product/price/@maxprice_net_formatted")}}
															{{else}}
																{{$loop359->getItemEscape("price/@maxprice_net_formatted")}}
															{{/if}}
														{{/capture}}
														<div class="product_prices">
															{{if $var_size_min_net_formatted  neq (string) $var_size_max_net_formatted}}
																...
																{{if $var_points_net  neq (string) ''}}
																	<span class="point-price">{{$var_points_net}}
																		<span class="currency">{{$txt['107919::58826_012']}}</span></span>
																{{/if}}
															{{elseif (($var_net_value  == (string) 0) and $var_points_net  == (string) '') or ($var_net_value  == (string) 0 and $main_hotspot_zone1_b2b_var and !($main_hotspot_zone1_b2b_var  == (string) '') and !( $loop359->getItem("/shop/basket/@wholesaler")  == (string) 'true'))}}
																<a {{assign "hrefAttributeTmp9" ""}}  class="fon_price" data-mobile-class="btn-small" {{if $main_hotspot_zone1_b2b_var and !($main_hotspot_zone1_b2b_var == (string) '')}} title="{{$main_hotspot_zone1_b2b_var}}"{{capture name="hrefAttributeTmp9" assign="hrefAttributeTmp9"}}{{$loop359->getItemEscape("/shop/action/signin/@url")}}{{/capture}}{{$main_hotspot_zone1_b2b_var}}{{else}} title="{{$txt['107919::58826_009']}}"{{capture name="hrefAttributeTmp9" assign="hrefAttributeTmp9"}}{{$loop359->getItemEscape("/shop/contact/link/@url")}}{{/capture}} {{$txt['107919::58826_010']}} {{/if}}  href="{{$hrefAttributeTmp9}}"></a>
															{{else}}
																...
																{{/if}}
															{{/if}}
															{{if  $loop359->getItem("price/@unit_converted_price_net_formatted")}}
																<small class="s_unit_converted_price">{{$loop359->getItemEscape("price/@unit_converted_price_net_formatted")}}{{literal}}/{{/literal}}{{$loop359->getItemEscape("price/@unit_converted_format")}}{{$var_net_prices}}</small>
															{{/if}}
														</div>
													{{/if}}
													{{if  $loop359->getItem("client/@client")}}
														<div class="client">{{$loop359->getItem("client/@client")}}
														</div>
													{{/if}}
													{{if  $loop359->getItem("@note")}}
														<div class="note">
															<span>
																<i {{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}icon-star{{/capture}}{{if $loop359->getItem("@note") gt (string) 0.5}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}icon-star active{{/capture}}{{/if}}  class="{{$classAttributeTmp4}}"></i>
																<i {{assign "classAttributeTmp5" ""}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}icon-star{{/capture}}{{if $loop359->getItem("@note") gt (string) 1.5}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}icon-star active{{/capture}}{{/if}}  class="{{$classAttributeTmp5}}"></i>
																<i {{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}icon-star{{/capture}}{{if $loop359->getItem("@note") gt (string) 2.5}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}icon-star active{{/capture}}{{/if}}  class="{{$classAttributeTmp6}}"></i>
																<i {{assign "classAttributeTmp7" ""}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}icon-star{{/capture}}{{if $loop359->getItem("@note") gt (string) 3.5}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}icon-star active{{/capture}}{{/if}}  class="{{$classAttributeTmp7}}"></i>
																<i {{assign "classAttributeTmp8" ""}}{{capture name="classAttributeTmp8" assign="classAttributeTmp8"}}icon-star{{/capture}}{{if $loop359->getItem("@note") gt (string) 4.5}}{{capture name="classAttributeTmp8" assign="classAttributeTmp8"}}icon-star active{{/capture}}{{/if}}  class="{{$classAttributeTmp8}}"></i></span>
															<small>{{$txt['107919::58826_oc']}}{{$loop359->getItem("@note")}}{{$txt['107919::58826_oce']}}</small>
														</div>
													{{/if}}
													{{if  $loop359->getItem("content")}}
														<div class="cleardescription">{{$loop359->getItem("content")}}
														</div>
													{{/if}}
												</div>
											{{/foreach}}
