					...
					<div {{assign "classAttributeTmp2" ""}}  id="content"{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}span9{{/capture}}{{if $xml->getItem("page[@type='projector']")}} itemscope="itemscope" itemtype="http://schema.org/Product" {{/if}}{{if $xml->getItem("page/@type") == (string) 'projector'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_projector_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'search'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_search_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'main'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_main_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'navigation'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_navigation_page_c_class']}}{{/capture}}{{elseif $xml->getItem("page/@type") == (string) 'blog-list' or $xml->getItem("page/@type") == (string) 'blog-item'}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_blog_c_class']}}{{/capture}}{{else}}{{capture name="classAttributeTmp2" assign="classAttributeTmp2"}}{{$txt['73991::70925_otherwise_c_class']}}{{/capture}}{{/if}}  class="{{$classAttributeTmp2}}">
						...
						{{if  $xml->getItem("/shop/basket/@login")}}
							<div class="noproduct_form_outline">
								<div {{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}noproduct_form_label{{/capture}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}noproduct_form_label big_label{{/capture}}  class="{{$classAttributeTmp3}}">
									<span class="noproduct_form_label">{{$txt['62108::noproduct_form_label']}}</span>
								</div>
								<div class="noproduct_form_sub">
									<form id="noproduct_form" method="post" action="{{$xml->getItemEscape("page/action/form/@url")}}">
										...
										<div class="noproduct_form_desc">{{$txt['62108::noproduct_form_desc']}}
										</div>
										<div class="noproduct_form_section">
											<div class="noproduct_form_left1">
												<span class="noproduct_form_title">{{$txt['62108::noproduct_form_title1']}}</span>
											</div>
											<div class="noproduct_form_right1">
												<input type="text" class="noproduct_form_name" name="name" {{if $xml->getItem("page/search_params/text/@value") neq (string) ''}} value=" {{$xml->getItemEscape("page/search_params/text/@value")}} " {{/if}}></input>
											</div>
										</div>
										<div class="noproduct_form_section">
											<div class="noproduct_form_left2">
												<span class="noproduct_form_title">{{$txt['62108::noproduct_form_title2']}}</span>
											</div>
											<div class="noproduct_form_right2">
												<textarea name="desc" class="noproduct_form_desc"></textarea>
											</div>
										</div>
										<div class="noproduct_form_submit">
											<a {{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}noproduct_form_submit{{/capture}} onclick="noproduct_form.checkForm();"{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}btn-small noproduct_form_submit{{/capture}} title="{{$txt['62108::noproduct_form_submit_title']}}"  class="{{$classAttributeTmp4}}">{{$txt['62108::noproduct_form_submit_txt']}}</a>
										</div>
										<div class="noproduct_form_desc2">{{$txt['62108::noproduct_form_desc2']}}
										</div>
									</form>
								</div>
							</div>
						...
						{{else}}
							<div class="noproduct_form_outline">
								...
								<div class="noproduct_form_sub">
									<p class="noproduct_form_notlogged">{{$txt['62108::noproduct_form_notlogged']}}
									</p>
								</div>
							</div>
						{{/if}}
						...
						{{if  $xml->getItem("page/text/body")}}
							<div {{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}noproduct_cms_label{{/capture}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}noproduct_cms_label big_label{{/capture}}  class="{{$classAttributeTmp6}}">
								<span class="noproduct_cms_label">{{$txt['58576::noproduct_cms_label']}}</span>
							</div>
