...
<div id="logo" data-align="a#css" class="{{$txt['74111::class_01']}}" {{if $xml->getItem("mask/top2/link/image/@src") and ( $xml->getItem("mask/top2/link/image/@width") gt (string)1 or $xml->getItem("mask/top2/link/image/@height") gt (string) 1)}} data-bg="{{$xml->getItemEscape("mask/top2/link/image/@src")}}"{{/if}}>
