...
{stock_map.loadGoogleMapsAPI(stock_map.mapInit);}}});var stock_map={geokoder:0,mapa:0,zoom:0,markerInfo:0,language:0,markerInfo:0,timeout:0,markerIcon:0,loadMapBool:false,loadNavBool:false,google_api_key:'',loadGoogleMapsAPI:function(callback){if((parent.location.protocol+'//')=='https://')
