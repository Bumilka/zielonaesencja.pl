						...
						<div class="products_requests_list">
							...
							<div class="products_requests_list_sub">
								<table class="products_requests_list" cellspacing="0" cellpadding="0">
									{{foreach from=$xml->getList("page/products_requests/item") item=loop301}}
										<tr class=" {{if $loop301@iteration % 2 == (string) 0}}products_requests_list_itemp{{/if}}{{if $loop301@iteration % 2 == (string) 1}}products_requests_list_itemn{{/if}} ">
											<td class="products_requests_list_info1">
												{{if  $loop301->getItem("@name")}}
													<div class="products_requests_list_name">
														<span class="products_requests_list_name">{{$loop301->getItemEscape("@name")}}</span>
													</div>
												{{/if}}
												{{if  $loop301->getItem("@desc")}}
													<div class="products_requests_list_desc">{{$loop301->getItemEscape("@desc")}}
													</div>
												{{/if}}
											</td>
											<td class="products_requests_list_info2">
												<div class="products_requests_list_date">
													...
													<span class="products_requests_list_date_val">{{$loop301->getItemEscape("@date")}}</span>
												</div>
												<a class="products_requests_list_remlink" href="{{$loop301->getItemEscape("@remove_link")}}" title="{{$txt['58582::products_requests_list_remlink_title']}}">{{$txt['58582::products_requests_list_remlink_txt']}}</a>
											</td>
										</tr>
									{{/foreach}}
								</table>
